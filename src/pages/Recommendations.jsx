...
export default function Recommendations() {
  ...
  return (
    <main className="flex-grow pt-24 pb-20 min-h-screen bg-slate-50/50 relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 rounded-full bg-blue-400/10 blur-[100px] pointer-events-none"></div>
      <div className="absolute top-1/2 left-0 -ml-20 w-72 h-72 rounded-full bg-indigo-400/10 blur-[100px] pointer-events-none"></div>
